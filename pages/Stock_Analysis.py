...
# # Important details
# show("Sector", "sector")
# show("Full Time Employees", "fullTimeEmployees")
# show("Website", "website")
# show("Country", "country")
# show("Industry", "industry")
...
# data = yf.download(ticker.strip().upper(), start=start_date, end=end_date, progress=False)

# if data.empty:
#     st.error("Invalid ticker or no data available. Try AAPL, MSFT, TSLA.")
#     st.stop()
# else:
#     col1, col2, col3 = st.columns(3)
#     daily_change = data['Close'].iloc[-1] - data['Close'].iloc[-2]
